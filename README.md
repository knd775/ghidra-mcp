...
- **265 MCP tools** — 3x more than any competing implementation. Not just read operations — full write access for renaming, typing, commenting, structure creation, script execution, P-code emulation, and live debugging.
...
- **265 MCP tools** — Comprehensive API surface covering every aspect of binary analysis
